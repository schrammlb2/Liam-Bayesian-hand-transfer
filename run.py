...
methods.append('traj_transfer_timeless_iterative')
...
real_base_command = 'python3 regression_traj.py acrobot_A '  
transfer_base_command = 'python3 regression_traj.py acrobot_transferB2A '
reps = 5
