...
def duration_lc_direct(task, threshold, method='nonlinear_transform'):
    mean_durs = []
    durs = []
...
lc_nl_trans= duration_lc_direct('transferB2A', threshold, method='direct')
