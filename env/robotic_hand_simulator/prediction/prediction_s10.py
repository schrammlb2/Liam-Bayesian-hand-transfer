...
pos_model_path = '../../../save_model/robotic_hand_simulator/d4_s10_pos'  # use to import weights and normalization arrays
load_model_path = '../../../save_model/robotic_hand_simulator/d4_s10_load'

PATH_NUM = 1  # which path to test
...
with open('../../../data/robotic_hand_simulator/test_trajectory/jt_path'+str(1)+'_v14_m10.pkl', 'rb') as pickle_file:
